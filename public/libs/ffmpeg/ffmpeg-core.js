var createFFmpegCore = (() => {
  ...
  return async function (createFFmpegCore = {}) {
    ...
    var wasmImports = {
      c: ___assert_fail,
      Aa: ___dlsym,
      na: ___emscripten_init_main_thread_js,
      z: ___emscripten_thread_cleanup,
      da: ___pthread_create_js,
      ba: ___pthread_kill_js,
      Z: ___syscall__newselect,
      Q: ___syscall_accept4,
      P: ___syscall_bind,
      O: ___syscall_connect,
      Ba: ___syscall_faccessat,
      j: ___syscall_fcntl64,
      wa: ___syscall_fstat64,
      aa: ___syscall_getdents64,
      N: ___syscall_getpeername,
      M: ___syscall_getsockname,
      L: ___syscall_getsockopt,
      D: ___syscall_ioctl,
      K: ___syscall_listen,
      ...
      pa: __emscripten_set_offscreencanvas_size,
      ma: __emscripten_thread_mailbox_await,
      ya: __emscripten_thread_set_strongref,
      ...
      xa: _emscripten_exit_with_live_runtime,
      X: _emscripten_get_heap_max,
      i: _emscripten_get_now,
      Y: _emscripten_num_logical_cores,
      oa: _emscripten_receive_on_main_thread_js,
    ...
    var ___wasm_call_ctors = function () {
      return (___wasm_call_ctors = Module["asm"]["Fa"]).apply(null, arguments);
    };
    ...
    var ___errno_location = function () {
      return (___errno_location = Module["asm"]["Ia"]).apply(null, arguments);
    };
    var _ntohs = function () {
      return (_ntohs = Module["asm"]["Ja"]).apply(null, arguments);
    };
    var _htons = function () {
      return (_htons = Module["asm"]["Ka"]).apply(null, arguments);
    };
    var _ffmpeg = (Module["_ffmpeg"] = function () {
      return (_ffmpeg = Module["_ffmpeg"] = Module["asm"]["La"]).apply(
        null,
        arguments
      );
    });
    ...
    var _emscripten_builtin_memalign = function () {
      return (_emscripten_builtin_memalign = Module["asm"]["Oa"]).apply(
        null,
        arguments
      );
    };
    ...
    var _htonl = function () {
      return (_htonl = Module["asm"]["Ra"]).apply(null, arguments);
    };
    ...
    var __emscripten_thread_free_data = function () {
      return (__emscripten_thread_free_data = Module["asm"]["Ta"]).apply(
        null,
        arguments
      );
    };
    ...
    var _setThrew = function () {
      return (_setThrew = Module["asm"]["Wa"]).apply(null, arguments);
    };
    var _emscripten_stack_set_limits = function () {
      return (_emscripten_stack_set_limits = Module["asm"]["Xa"]).apply(
        null,
        arguments
      );
    };
    var stackSave = function () {
      return (stackSave = Module["asm"]["Ya"]).apply(null, arguments);
    };
    var stackRestore = function () {
      return (stackRestore = Module["asm"]["Za"]).apply(null, arguments);
    };
    var stackAlloc = function () {
      return (stackAlloc = Module["asm"]["_a"]).apply(null, arguments);
    };
    var _ff_h264_cabac_tables = (Module["_ff_h264_cabac_tables"] = 1534124);
    var ___start_em_js = (Module["___start_em_js"] = 6030565);
    var ___stop_em_js = (Module["___stop_em_js"] = 6030742);
